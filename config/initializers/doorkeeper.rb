...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    Profile.find_by_id(cookies.signed[:profile_id]) || redirect_to(new_user_session_url)
  end
  ...
  admin_authenticator do
    ...
    # Example implementation:
    current_profile = Profile.find_by_id(cookies.signed[:profile_id])
    if current_profile
      head :forbidden unless current_profile.admin?
    else
