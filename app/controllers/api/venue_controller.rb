class Api::VenueController < ApiController
  ...
  def venue_params
    params.require(:venue).permit(
      ...
      venue_overrides: [ :id, :venue_id, :day, :disabled, :start_at, :end_at, :role, :_destroy ],
      venue_timeslots: [ :id, :venue_id, :day_of_week, :disabled, :start_at, :end_at, :role, :_destroy ],
      availabilities: [ :id, :item_id, :item_type, :day_of_week, :day, :intervals, :role, :_destroy ]
    )
  end
end
