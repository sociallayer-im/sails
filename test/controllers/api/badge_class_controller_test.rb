...
class Api::BadgeClassControllerTest < ActionDispatch::IntegrationTest
  test "create" do
    ...
    assert_difference "BadgeClass.count", 1 do
      post api_badge_class_create_url, params: { auth_token: auth_token,  group_id: 1, name: "test", title: "test", content: "test badge class", transferable: true, image_url: "https://test.com/image.png" }
    end
